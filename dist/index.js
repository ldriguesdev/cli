...
const app = async () => {
    ...
    if (fs.existsSync(projectPath)) {
        console.log(chalk.red(`O diretório "${projectName}" já existe. Por favor, escolha outro nome.`));
        process.exit(1);
    }
    ...
    try {
        switch (framework) {
            case "Next.js":
                ...
                shell.exec(`${packageManager === "pnpm"
                    ? "pnpm dlx"
                    : packageManager === "yarn"
                        ? "yarn create"
                        : "npx"} create-next-app@latest ${projectName} --typescript --eslint --app`);
                break;
            case "Nest.js":
                ...
                shell.exec(`${packageManager === "pnpm"
                    ...
                    : packageManager === "yarn"
                        ? "yarn create"
                        : "npx"} @nestjs/cli new ${projectName} --language ts`);
                break;
            case "React.js":
            ...
            case "Node.js":
                ...
                // src/index.ts
                fs.writeFileSync(path.join(projectPath, "src", "index.ts"), `console.log("🚀 Servidor Node com TypeScript iniciado!");`);
                // package.json
